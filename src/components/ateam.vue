...
<style scoped>
.country {background-color: #fff; margin-right: 10px; width: 230px; float: left; margin-top: 50px; border: 1px solid #e5e5e5 !important; box-shadow: 0 3px 10px 4px rgba(0,0,0,0.04); height: 326px;}
